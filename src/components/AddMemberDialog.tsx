...
import { useAddHouseholdProfile } from "@/hooks/useHouseholdProfiles";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-sm bg-card border-border">
        <DialogHeader>
          ...
          <DialogDescription>Add an adult or child to your household.</DialogDescription>
        </DialogHeader>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-2">
          ...
          <Button type="submit" className="w-full" disabled={addProfile.isPending}>
            {addProfile.isPending ? "Adding…" : "Add Member"}
          </Button>
        </form>
      </DialogContent>
    </Dialog>
